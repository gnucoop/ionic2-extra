...
# This script should be run from the root of the ionic2-extra repo.
...
if [ "${NPM_USER}" != "ionic2-extra" ]; then
  echo "You must be logged in as 'ionic2-extra' to publish. Use 'npm login'."
  exit
fi
